/*!
 ...
 Ā©2015 SpryMedia Ltd - datatables.net/license
*/
(function(e) {
				...
				if(h)
					if(e.isArray(h)) this._buildButtons(h, b, c);
						...
						if(i) {
							var q = i.node;
							b.append(i.inserter);
              this.s.subButtons[c] = (Array.isArray(this.s.subButtons[c])) ? this.s.subButtons[c] : [];
		...
		collection: {
			...
			action: function(a, b, c, d) {
				...
				f && "absolute" === g ? d._collection.css({
					...
					left: a.left
				}), c = a.left + d._collection.outerWidth(), b = b.offset().left + b.width(), c > b && d._collection.css("left", a.left - (c - b))) : (a = d._collection.height() / 2, a > e(n).height() / 2 && (a = e(n).height() / 2), d._collection.css("marginTop", -1 * a));
...
(function(f) {
	...
	var o = function(a, b) {
		...
		n = function(a, b) {
			var d = "*" === a.filename && "*" !== a.title && a.title !== m ? a.title : a.filename; - 1 !== d.indexOf("*") && (d = d.replace("*", f("title").text()));
		...
		p = function(a, b) {
			for(var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n", c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, h = RegExp(e, "g"), r = b.escapeChar !== m ? b.escapeChar : "\\", g = function(a) {
					for(var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += f), b += e ? e + ("" + a[c]).replace(h, r + e) + e : a[c];
					return b
	...
	i.ext.buttons.copyFlash = f.extend({}, l, {
		...
		action: function(a, b, d, c) {
			c._fromFlash && (a = c._flash, c = p(b, c), a.setAction("copy"), k(a, c.str), b.buttons.info(b.i18n("buttons.copyTitle", "Copy to clipboard"), b.i18n("buttons.copyInfo", {
			...
			var a = "",
				...
				e = function(a) {
					for(var b = [], c = 0, d = a.length; c < d; c++) {
						...
						b.push("number" === typeof a[c] || a[c].match && a[c].match(/^-?[0-9\.]+$/) && "0" !== a[c].charAt(0) ? '<c t="n"><v>' + a[c] + "</v></c>" : '<c t="inlineStr"><is><t>' + (!a[c].replace ? a[c] : a[c].replace(/&(?!amp;)/g, "&amp;").replace(/[\x00-\x1F\x7F-\x9F]/g, "")) + "</t></is></c>")
					}
...
(function(g) {
	...
	if("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) j = void 0;
		...
		var v = d.document,
			...
			y = function(a) {
				return /^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(a.type) ? new Blob(["ļ»æ", a], {
					type: a.type
				}) : a
			},
			A = function(a, b) {
	...
	l.ext.buttons.copyHtml5 = {
		...
		action: function(a, b, d, c) {
			...
			a = g("<span>" + b.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>ā</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") + "</span>").append(d);
