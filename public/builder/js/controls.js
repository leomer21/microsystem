...
var controls = {
    ...
    , findParent: function(el, arrClassName) {
        ...
        for (var indx in arrClassName) {
            while (DOM && !DOM.classList.contains(arrClassName[indx])) {
    ...
    , changePropertyMargin: function(child, wrap) {
        ...
        wrap.style.margin = '0';
        var elementStyleMargin = computedElStyle.getPropertyValue("margin");
        wrap.style.margin = elementStyleMargin;
    ...
    , rebuildControl: function(wrap) {
        ...
        Array.prototype.forEach.call(wrapControl, function(element) {
            ...
            if (element.classList.contains('wrap-control')) {
                ...
                var section = _this.findParent(parent, ['section-item']).children[0];
