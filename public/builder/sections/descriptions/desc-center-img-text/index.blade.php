<section id="desc-center-img-text" class="pb-125">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <img src="./sections/descriptions/desc-center-img-text/images/phone-bottom.png" srcset="./sections/descriptions/desc-center-img-text/images/phone-bottom@2x.png 2x" alt="" class="screen">
            </div>
