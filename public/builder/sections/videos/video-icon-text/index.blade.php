<section id="video-icon-text" class="pt-200 pb-200 bg-1-color-dark dark">
    <div class="container">
        <div class="row flex-md-vmiddle">
            <div class="col-md-6 text-center">
                <a href="https://vimeo.com/123395658" class="single-iframe-popup spr-option-link"><i class="icon-ion-ios-play-outline icon-size-xl icon-color"></i></a>
            </div>
            <div class="col-md-6">
