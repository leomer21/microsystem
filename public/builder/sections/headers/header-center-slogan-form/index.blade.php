<header id="header-center-slogan-form" class="pt-100 pb-100 bg-3-color-light text-center">
    <div class="container">
        <div class="row flex-md-vmiddle">
            <div class="col-md-12">
                <img class="screen mb-50" src="./sections/headers/header-center-slogan-form/images/menu-logo.png" srcset="./sections/headers/header-center-slogan-form/images/menu-logo@2x.png 2x" alt="logo">
                ...
                <div class="compressed-box-50">
                    ...
                    <form action="scripts/request.php" class="contact_form">
                        ...
                        <button type="submit" data-loading-text="&bull;&bull;&bull;" data-complete-text="Completed!" data-reset-text="Try again later..." class="btn btn-block btn-primary contact_submit"><span class="spr-option-textedit-link">Ask</span></button>
                    </form>
