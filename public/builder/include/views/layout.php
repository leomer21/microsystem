...
<head>
	...
	<title>Microsystem Landing builder</title>
...
<aside class="control-panel supra black">
	...
	<ul class="typography">
		<?php
			...
			foreach ($this->fontsDropdown as $font) {
				$light = '';
				if ((int) $font['font_weight'] < 400 && (int) $font['font_weight'] > 100) {
					$light = ' light';
					...
					<div class="item">
						...
						<div class="dropdown">
							...
							aria-expanded="false">
								...
								<i class="supra icon-chevron-down"></i>
							</button>
	...
	<div class="project-pages">
		...
		<div class="btn-ex-im-d">
			...
			<div type="button" class="supra-btn btn-success download">
