	...
	require_once 'include/config.php';
		...
		if($sys_local_or_web=="local")
		{
			if($me_local_or_web=="local"){$can_go="yes";}
				...
				$url = $local_url."?op=setMessagesReaded";
...
//////////////////////////////////////////////////////////////// Confirm PIN ////////////////////////////////////////////////////////////////////
				...
				$setMessageReaded="update `orders` set `read`='yes' where `order_id`='$messageId'";
					if(@mysql_query($setMessageReaded))
					{
						...
						$status=0;if($login_lang=="ar"){$status_message="";}else{ $status_message="";}
						$data_before = array("status" => "$status", "statusMessage" => "$status_message");                                                                    
						echo $data = json_encode($data_before);
					}
//////////////////////////////////////////////////////////////// Confirm PIN ////////////////////////////////////////////////////////////////////
