	...
	require_once 'include/config.php';
		...
		if($sys_local_or_web=="local")
		{
			if($me_local_or_web=="local"){$can_go="yes";}
				...
				$url = $local_url."?op=sendMessageReply";
				...
				, "type" => "reply", "replySubject" => "$replySubject", "replyID" => "$replyID", "message" => "$msgMessage");                                                                    
...
//////////////////////////////////////////////////////////////// Charge Card ////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////// Charge Card ////////////////////////////////////////////////////////////////////
$getLastMessageContent="select `order_answer` from `orders` where `order_id`='$replyID'";
$r_getLastMessageContent=@mysql_query($getLastMessageContent);
$row_getLastMessageContent=@mysql_fetch_array($r_getLastMessageContent);
$LastMessageContent=$row_getLastMessageContent['order_answer'];
$msgMessage="<center>REPLY from RE$replySubject <br> ID:$replyID <br> Contect : $LastMessageContent</center><hr>".$msgMessage;
		...
		('reply','$db_u_mail','$u_mobile','$msgMessage','active',$db_id,'user','$db_u_name','$db_u_uname','$today','$today_time')";				
