	...
	require_once 'include/config.php';
		...
		if($sys_local_or_web=="local")
		{
			if($me_local_or_web=="local"){$can_go="yes";}
				...
				$url = $local_url."?op=getPackagesInternetExtraBandwidth";
...
//////////////////////////////////////////////////////////////// Charge Card ////////////////////////////////////////////////////////////////////
	        		...
	        		,`limit_profile_id`,`offer`,`offer_start_date`,`offer_start_time`,`offer_end_date`,`offer_end_time` from packages where type='bandwidth_card' and state='active' and network_code='$network_code' and hotspot_or_ppp='$hotspot_or_ppp' and limit_profile_id is null  ORDER BY id ASC";}
	        		else{$get_packages="select `id`,`network_code`,`name`,`type`,`price`,`period`,`speed_profile_id`
	        		,`limit_profile_id`,`offer`,`offer_start_date`,`offer_start_time`,`offer_end_date`,`offer_end_time` from `packages` where  type='bandwidth_card' and `state`='active' and `network_code`='$network_code' and hotspot_or_ppp='$hotspot_or_ppp'  ORDER BY id ASC";}
