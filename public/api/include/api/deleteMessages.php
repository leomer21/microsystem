<?php
	...
	$login_lang = $obj['lang'];
	$deleteMessageID = $obj['deleteMessageID'];
	 ...
	 ///////////////////////////////////////////////////     
		...
		if($sys_local_or_web=="local")
		{
			if($me_local_or_web=="local"){$can_go="yes";}
				...
				$url = $local_url."?op=deleteMessages";
...
//////////////////////////////////////////////////////////////// Charge Card ////////////////////////////////////////////////////////////////////
				...
				$search_answer="delete from `orders` where `order_id`='$deleteMessageID'";
                
                if(@mysql_query($search_answer,$conn_user)) 
                {
                    if($login_lang=="ar"){$status_message=$deletedMessage_ar;}else{ $status_message=$deletedMessage_en;}
				...
				echo json_encode($json);
					...
					$status=0;if($login_lang=="ar"){$status_message="sorry, error where deleting";}else{ $status_message="sorry, error where deleting";}
