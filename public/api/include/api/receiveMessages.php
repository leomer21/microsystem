	...
	require_once 'include/config.php';
		...
		if($sys_local_or_web=="local")
		{
			if($me_local_or_web=="local"){$can_go="yes";}
				...
				$url = $local_url."?op=receiveMessages";
...
//////////////////////////////////////////////////////////////// Charge Card ////////////////////////////////////////////////////////////////////
				...
				$search_answer="select * from orders where order_user_id=$db_id and order_type='user' and order_answer!='null' order by `order_id` DESC";
                ...
                $HTMLstart="<html dir='rtl'><center><p align='right'> ";
                $HTMLend=" </p></center></html>";
				while ($row_search_answer=@mysql_fetch_array($result_search_answer)) {
				  ...
				  $row_bot_messages['messageContent']= $HTMLstart.$order_answer.$HTMLend;
