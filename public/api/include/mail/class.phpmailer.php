...
class PHPMailer
{
     ...
     * @access public
     */
    public function setLanguage($langcode = 'ar', $lang_path = 'language/')
    {
     ...
     * Adapted from a function by paravoid at http://uk.php.net/manual/ar/function.mb-encode-mimeheader.php
     * @access public
     * @param string $str multi-byte text to wrap encode
     ...
     * @return string
     * @link PHP version adapted from http://www.php.net/manual/ar/function.quoted-printable-decode.php#89417
     */
    ...
    protected function lang($key)
    {
        if (count($this->language) < 1) {
            $this->setLanguage('ar'); // set the default language
        }
