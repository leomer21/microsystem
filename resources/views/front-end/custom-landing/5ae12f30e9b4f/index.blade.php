...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/5ae12f30e9b4f') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ae12f30e9b4f') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ae12f30e9b4f') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ae12f30e9b4f') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ae12f30e9b4f') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ae12f30e9b4f') }}/css/index.css" />
	</head>
    <body class="light-page">
		...
		<script src="{{ asset('/custom-landing/5ae12f30e9b4f') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/5ae12f30e9b4f') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/5ae12f30e9b4f') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/5ae12f30e9b4f') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/5ae12f30e9b4f') }}/js/index.js"></script>
	</body>
</html>