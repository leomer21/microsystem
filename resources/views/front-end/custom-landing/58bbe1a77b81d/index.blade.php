...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/58bbe1a77b81d') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbe1a77b81d') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbe1a77b81d') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbe1a77b81d') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbe1a77b81d') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbe1a77b81d') }}/css/index.css" />
	</head>
...
<nav id="nav-fluid-logo-menu-btn-2" class="navbar navbar-fixed-top dark">
            ...
            <div class="col-md-2 text-left">
                <div class="row no-pad">
                    <div class="col-xs-6 col-md-12">
                        <div class="navbar-brand"><img src="{{ asset('/custom-landing/58bbe1a77b81d') }}/images/logo.png" srcset="{{ asset('/custom-landing/58bbe1a77b81d') }}/images/logo@2x.png 2x" alt="Your logo"></div>
                    </div>
    ...
    <div class="nav-bg bg-2-color-dark"></div>
    			...
    			<div class="container">
        			<div class="row">
            			<div class="col-md-12 text-center">
                			...
                			<div class="mt-50">
                    			<img src="{{ asset('/custom-landing/58bbe1a77b81d') }}/images/logo-mid.png" srcset="{{ asset('/custom-landing/58bbe1a77b81d') }}/images/logo-mid@2x.png 2x" alt="Your logo">
                			</div>
            			</div>
        			</div>
    			</div>
		...
		<script src="{{ asset('/custom-landing/58bbe1a77b81d') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/58bbe1a77b81d') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/58bbe1a77b81d') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/58bbe1a77b81d') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/58bbe1a77b81d') }}/js/index.js"></script>
	</body>
</html>