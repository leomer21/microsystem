...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/5c1d742472881') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d742472881') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d742472881') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d742472881') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d742472881') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d742472881') }}/css/index.css" />
	</head>
...
<nav id="nav-fluid-logo-menu-btn" class="navbar navbar-fixed-top dark">
            ...
            <div class="col-md-2 text-left">
                <div class="row no-pad">
                    <div class="col-xs-6 col-md-12">
                        <div class="navbar-brand"><img src="{{ asset('/custom-landing/5c1d742472881') }}/images/logo.png" srcset="{{ asset('/custom-landing/5c1d742472881') }}/images/logo@2x.png 2x" alt="Your logo"></div>
                    </div>
    ...
    <div class="nav-bg bg-2-color-dark"></div>
			...
			<section id="benefit-3col" class="pt-150 pb-150 bg-1-color-light light">
    			<div class="container">
        			<div class="row">
            			<div class="col-md-4">
                			<div class="content-box">
                    			<i class="icon-screen icon-size-xl icon-color mb-25"></i>
                    			<h2 class="mb-25">Fresh interface</h2>
            			...
            			<div class="col-md-4">
                			<div class="content-box">
                    			<i class="icon-paint-roller icon-size-xl icon-color mb-25"></i>
                    			<h2 class="mb-25">Unlimited colors</h2>
                    			<p class="mb-50"> So, what is the secret of successful template design? First of all, it is its friendliness – both for the template’s owner and for his or her future targeted audience.</p>
                    			<a href="#" class="btn btn-primary"><span>Try now</span><i class="icon-window icon-size-m icon-position-right"></i></a>
                			</div>
            			</div>
            			<div class="col-md-4">
                			<div class="content-box">
                    			<i class="icon-shield-check icon-size-xl icon-color mb-25"></i>
                    			<h2 class="mb-25">24/7 Support</h2>
                    			<p class="mb-50"> So, what is the secret of successful template design? First of all, it is its friendliness – both for the template’s owner and for his or her future targeted audience.</p>
                    			<a href="#" class="btn btn-primary"><span>Try now</span><i class="icon-window icon-size-m icon-position-right"></i></a>
                			</div>
            			</div>
    			...
    			<div class="bg"></div>
			</section><header id="header-center-slogan-img" class="pt-150 pb-0 dark bg-3-color-dark">
    			<div class="container">
        			<div class="row  text-center">
            			<div class="col-md-12">
                			...
                			<img src="{{ asset('/custom-landing/5c1d742472881') }}/images/phone-top.png" srcset="{{ asset('/custom-landing/5c1d742472881') }}/images/phone-top@2x.png 2x" alt="" class="screen mt-125">
            			</div>
        			</div>
    			</div>
		...
		<script src="{{ asset('/custom-landing/5c1d742472881') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d742472881') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d742472881') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d742472881') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/5c1d742472881') }}/js/index.js"></script>
	</body>
</html>