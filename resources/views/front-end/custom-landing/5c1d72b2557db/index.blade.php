...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d72b2557db') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d72b2557db') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d72b2557db') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d72b2557db') }}/css/owl.carousel.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d72b2557db') }}/css/magnific-popup.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d72b2557db') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5c1d72b2557db') }}/css/index.css" />
	</head>
...
<nav id="nav-fluid-logo-menu" class="navbar navbar-fixed-top dark">
            ...
            <div class="col-md-2 text-left">
                <div class="row no-pad">
                    <div class="col-xs-6 col-md-12">
                        <div class="navbar-brand"><img src="{{ asset('/custom-landing/5c1d72b2557db') }}/images/logo.png" srcset="{{ asset('/custom-landing/5c1d72b2557db') }}/images/logo@2x.png 2x" alt="Your logo"></div>
                    </div>
    ...
    <div class="nav-bg bg-1-color-dark"></div>
			...
			<section id="action-text-btn-img" class="bg-1-color-dark dark pt-100 pb-100">
    			<div class="container">
        			<div class="row flex-md-vmiddle">
            			...
            			<div class="col-md-6 col-md-offset-1 text-center">
                			<img src="{{ asset('/custom-landing/5c1d72b2557db') }}/images/phone-landscape-2.png" srcset="{{ asset('/custom-landing/5c1d72b2557db') }}/images/phone-landscape-2@2x.png 2x" alt="iPhone" class="screen">
            			</div>
        			</div>
    			</div>
    			<div class="bg"></div>
    			...
    			<div class="single-carousel gallery"><div class="item container">
            			<img src="{{ asset('/custom-landing/5c1d72b2557db') }}/images/browser-window-1.png" srcset="{{ asset('/custom-landing/5c1d72b2557db') }}/images/browser-window-1@2x.png 2x" alt="" class="screen">
            			...
            			<img src="{{ asset('/custom-landing/5c1d72b2557db') }}/images/browser-window-2.png" srcset="{{ asset('/custom-landing/5c1d72b2557db') }}/images/browser-window-2@2x.png 2x" alt="" class="screen">
            			...
            			<img src="{{ asset('/custom-landing/5c1d72b2557db') }}/images/browser-window-3.png" srcset="{{ asset('/custom-landing/5c1d72b2557db') }}/images/browser-window-3@2x.png 2x" alt="" class="screen">
		...
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/owl.carousel.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/jquery.magnific-popup.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/5c1d72b2557db') }}/js/index.js"></script>
	</body>
</html>