...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbdfc46b9a8') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbdfc46b9a8') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbdfc46b9a8') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbdfc46b9a8') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58bbdfc46b9a8') }}/css/index.css" />
	</head>
...
<nav id="nav-fluid-logo-menu" class="navbar navbar-fixed-top dark">
            ...
            <div class="col-md-2 text-left">
                <div class="row no-pad">
                    <div class="col-xs-6 col-md-12">
                        <div class="navbar-brand"><img src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/logo.png" srcset="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/logo@2x.png 2x" alt="Your logo"></div>
                    </div>
    ...
    <div class="nav-bg bg-1-color-dark"></div>
			...
			</header> @include('...front-end.landing.custom_auth_js') <section id="clients-5col" class="pt-50 pb-50 bg-2-color-light light">
    			<div class="container">
        			<div class="row">
            			<div class="col-md-20 col-sm-4 text-center">
                			<div class="content-box no-space">
                    			<a href="#">
                        			<img class="screen" src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-1.png" srcset="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-1@2x.png 2x" alt="Client">
                    			</a>
                			</div>
            			</div>
            			<div class="col-md-20 col-sm-4 text-center">
                			<div class="content-box no-space">
                    			<a href="#">
                        			<img class="screen" src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-2.png" srcset="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-2@2x.png 2x" alt="Client">
                    			</a>
                			</div>
            			</div>
            			<div class="col-md-20 col-sm-4 text-center">
                			<div class="content-box no-space">
                    			<a href="#">
                        			<img class="screen" src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-3.png" srcset="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-3@2x.png 2x" alt="Client">
                    			</a>
                			</div>
            			</div>
            			<div class="col-md-20 col-sm-4 text-center">
                			<div class="content-box no-space">
                    			<a href="#">
                        			<img class="screen" src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-4.png" srcset="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-4@2x.png 2x" alt="Client">
                    			</a>
                			</div>
            			</div>
            			<div class="col-md-20 col-sm-4 text-center">
                			<div class="content-box no-space">
                    			<a href="#">
                        			<img class="screen" src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-5.png" srcset="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/client-5@2x.png 2x" alt="Client">
                    			</a>
                			</div>
            			</div>
        			</div>
    			...
    			<div class="container">
        			<div class="row">
            			<div class="col-md-12 text-center">
                			...
                			<div class="mt-50">
                    			<img src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/logo-mid.png" srcset="{{ asset('/custom-landing/58bbdfc46b9a8') }}/images/logo-mid@2x.png 2x" alt="Your logo">
                			</div>
            			</div>
        			</div>
    			</div>
		...
		<script src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/58bbdfc46b9a8') }}/js/index.js"></script>
	</body>
</html>