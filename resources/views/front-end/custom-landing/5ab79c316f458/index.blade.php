...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/5ab79c316f458') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ab79c316f458') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ab79c316f458') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ab79c316f458') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ab79c316f458') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ab79c316f458') }}/css/index.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5ab79c316f458') }}/css/preloader.css" />
	</head>
...
<nav id="nav-fluid-logo-menu-btn" class="navbar navbar-fixed-top dark">
            ...
            <div class="col-md-2 text-left">
                <div class="row no-pad">
                    <div class="col-xs-6 col-md-12">
                        <div class="navbar-brand"><img src="{{ asset('/custom-landing/5ab79c316f458') }}/images/logo.png" srcset="{{ asset('/custom-landing/5ab79c316f458') }}/images/logo@2x.png 2x" alt="Your logo"></div>
                    </div>
    ...
    <div class="nav-bg bg-2-color-dark"></div>
			...
			</header> @include('...front-end.landing.custom_auth_js') <footer id="footer-logo-social" class="bg-2-color-dark dark pt-100 pb-100">
    			<div class="container">
        			<div class="row">
            			...
            			<div class="col-md-6 text-md-left col-md-pull-6">
                			<div class="float-box">
                   			<img src="{{ asset('/custom-landing/5ab79c316f458') }}/images/logo.png" srcset="{{ asset('/custom-landing/5ab79c316f458') }}/images/logo@2x.png 2x" alt="Your logo" class="float-left-md">
		...
		<script src="{{ asset('/custom-landing/5ab79c316f458') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/5ab79c316f458') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/5ab79c316f458') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/5ab79c316f458') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/5ab79c316f458') }}/js/index.js"></script>
	</body>
</html>