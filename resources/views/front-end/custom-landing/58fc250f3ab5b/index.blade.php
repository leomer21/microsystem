...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/58fc250f3ab5b') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/58fc250f3ab5b') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58fc250f3ab5b') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58fc250f3ab5b') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58fc250f3ab5b') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/58fc250f3ab5b') }}/css/index.css" />
	</head>
    <body class="light-page">
		...
		<script src="{{ asset('/custom-landing/58fc250f3ab5b') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/58fc250f3ab5b') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/58fc250f3ab5b') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/58fc250f3ab5b') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/58fc250f3ab5b') }}/js/index.js"></script>
	</body>
</html>