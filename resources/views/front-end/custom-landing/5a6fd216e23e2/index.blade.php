...
<html lang="en">
	<head>
		...
		<script src="{{ asset('/custom-landing/5a6fd216e23e2') }}/js/fonts.js"></script>
		<!-- Global stylesheets -->
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/5a6fd216e23e2') }}/css/bootstrap.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5a6fd216e23e2') }}/css/icons.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5a6fd216e23e2') }}/css/style.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5a6fd216e23e2') }}/css/custom.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5a6fd216e23e2') }}/css/index.css" />
	</head>
...
<nav id="nav-fluid-logo-menu" class="navbar navbar-fixed-top dark">
            ...
            <div class="col-md-2 text-left">
                <div class="row no-pad">
                    <div class="col-xs-6 col-md-12">
                        <div class="navbar-brand"><img src="{{ asset('/custom-landing/5a6fd216e23e2') }}/images/logo.png" srcset="{{ asset('/custom-landing/5a6fd216e23e2') }}/images/logo@2x.png 2x" alt="Your logo"></div>
                    </div>
    ...
    <div class="nav-bg bg-1-color-dark"></div>
			...
			</header> @include('...front-end.landing.custom_auth_js') <section id="contact-text-map" class="pt-150 pb-150 bg-1-color-light light">
    			<div class="container">
        			<div class="row flex-md-vmiddle">
            			<div class="col-md-5">
                			<h2 class="mb-50">Location</h2>
                			<p class="mb-50">Follow us in social networks. You can also subscribe for our news. We are going to provide you with actual and important for you information without spam or fluff.</p>
                			<ul class="text-icon-list">
                    			<li><i class="icon-map2"></i><span>Our Location Address</span></li>
                    			<li><i class="icon-at-sign"></i><span>Our Email</span></li>
                    			<li><i class="icon-phone-incoming"></i><span>Our Phone</span></li>
                    			<li><i class="icon-clock"></i><span>Our Work Hours</span></li>
                			</ul>
            			</div>
            			<div class="col-md-6 col-md-offset-1">
                			<div id="contact-text-map-map" class="embed-responsive embed-responsive-4by3 g-map"></div>
            			</div>
        			</div>
    			</div>
    			<div class="bg"></div>
    			...
    			<div class="container">
        			<div class="row">
            			<div class="col-md-12 text-center">
                			...
                			<div class="mt-50">
                    			<img src="{{ asset('/custom-landing/5a6fd216e23e2') }}/images/logo-mid.png" srcset="{{ asset('/custom-landing/5a6fd216e23e2') }}/images/logo-mid@2x.png 2x" alt="Your logo">
                			</div>
            			</div>
        			</div>
    			</div>
		...
		<script src="{{ asset('/custom-landing/5a6fd216e23e2') }}/js/jquery-2.1.4.min.js"></script>
		<script src="{{ asset('/custom-landing/5a6fd216e23e2') }}/js/bootstrap.min.js"></script>
		<script src="{{ asset('/custom-landing/5a6fd216e23e2') }}/js/skrollr.js"></script>
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCByts0vn5uAYat3aXEeK0yWL7txqfSMX8"></script>
		<script src="https://cdn.jsdelivr.net/jquery.goodshare.js/3.2.8/goodshare.min.js"></script>
		<script src="{{ asset('/custom-landing/5a6fd216e23e2') }}/js/custom.js"></script>
		<script src="{{ asset('/custom-landing/5a6fd216e23e2') }}/js/index.js"></script>
	</body>
</html>