...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{ asset('/custom-landing/5a6799dab2ad8') }}/css/geek_zone_co-working_space.css" />
		<link rel="stylesheet" href="{{ asset('/custom-landing/5a6799dab2ad8') }}/css/preloader.css" />
	</head>
...
<nav id="nav-fluid-menu-social" class="navbar navbar-fixed-top light">
        ...
        <div class="row no-pad">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <div class="col-md-6 text-md-left">
                    <ul class="nav">
                        <li><span><a href="http://www.geekzonecenter.com/" target="_blank" class="smooth">About us</a></span></li>
                        <li><span><a href="https://www.facebook.com/groups/189756778250326/" target="_blank" class="smooth">W</a>orkshop club</span></li>
                ...
                <div class="col-md-6 text-md-right">
                    <ul class="social-list">
                        ...
                        <li>
                            <a href="https://www.facebook.com/geekzonecenter/" target="_blank" class="smooth"><i class="icon-facebook icon-size-m"></i></a>
                        </li>
                        
                        
                        <li>
                            <a href="http://www.geekzonecenter.com/" target="_blank" class="smooth"><i class="icon-home4 icon-size-m"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="nav-bg bg-1-color-light"></div>
    			...
    			<div class="container">
        			<div class="row no-pad text-center">
            			<div class="col-md-12">
                			...
                			<a class="btn btn-link goto smooth" target="_self" href="http://geek-zone.microsystem.com.eg/builder/index.php?type=landing#header-form-slogan"><i class="icon-arrow-down icon-size-m icon-position-left"></i><span><strong>Sign Up Now!</strong></span></a>
            			</div>
        			</div>
    			</div>
			...
			</header><header id="header-form-slogan" class="pt-125 pb-150 dark bg-2-color-dark">
    			<div class="container">
        			<div class="row flex-md-vmiddle">
            			...
            			<div class="col-md-6 col-md-offset-1">
                			<h1><strong>Sign up</strong><br>To get your internet</h1><h1><b></b><mark><b>Join our&nbsp;<br></b>Workshop Club Now!</mark></h1>
                			<p><strong><span class="text-uppercase">Signup and Connect</span></strong></p>
            			</div>
        			</div>
    			</div>
		...
		<script src="{{ asset('/custom-landing/5a6799dab2ad8') }}/js/jquery.smooth-scroll.min.js"></script>
		...
		<script src="{{ asset('/custom-landing/5a6799dab2ad8') }}/js/geek_zone_co-working_space.js"></script>
	</body>
</html>