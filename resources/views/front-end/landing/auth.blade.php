<?php
$string = file_get_contents("/home/hotspot/public_html/resources/views/front-end/landing/lg.json");
$json_a = json_decode($string, true);
$allcode = $json_a['other'][0]['data']['code'];
// header('X-Frame-Options: ALLOW-FROM http://credit-agricole.microsystem.com.eg/'); 
// $systemCountry=App\Settings::where('type', 'country')->value('value');
// <option @if($systemCountry=="Russian Federation") selected @endif value="+7">Russia +7</option>
$dataCode = "";
foreach ($allcode as $key => $value) {

    $dataCode .= "<option value=\"{$value['dial_code']}\">{$value['name']} +{$value['dial_code']} </option>";
}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if(isset($social_mobile_exist) && $social_mobile_exist == 1)
                    <br><center><span style="color:red;"><i class="icon-phone-error position-left"></i> Hmmm, Mobile already exist</span></center>
                    <br>
                    <form class="signupForm" action="{{ url('social_signup_kit') }}" method="post" id="form">
                       {{ csrf_field() }}
...
<!-- select select -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback has-feedback-left">
                                <input type="number" class="form-control" name="mobile" placeholder="Mobile number" maxlength="11" onkeypress="return isNumber(event)" id="phone" >
                            </div>
                        </div>  
                    </form>
                    <br> 
                ...
                @if(isset($successfullRegistration) &&  $successfullRegistration == 1)
                    <center>
                        ...
                        <h1 style="color:green;">Your Account has been created successfully</h1>

                        <h7 style="color:green;" >Please wait while network administrator confirm your account. </h7>
                        <br>{{ App\Settings::where('type','phone')->value('value') }}
                        <br><br>
...
<!-- select select -->
                    ...
                    @else
                        ...
                        <form class="signupForm" method="POST" action="{{ url('confirm') }}" >
                            {{ csrf_field() }}
                            <div class="form-group has-feedback has-feedback-left">
                                <input name="sms_code" type="number" class="form-control" placeholder="Confirm code">
                                <input name="user_id" type="hidden" value="{{ $u_id }}">
                            </div>
                            <a  class="help-block text-danger" style="color:black" href="{{ url('showcode/'.$u_id) }}">Send confirmation code again!</a>
                            <div class="form-group">
                    ...
                    @elseif(isset($confirm_error) &&  $confirm_error == 1)
                        <center>
                            <img src="{{ asset('/') }}landing/img/wrong.png"></img>
                            <h1 style="color:red;">Error in Confirmation Code</h1>
                            <form class="signupForm" method="POST" action="{{ url('confirm') }}" >
                                {{ csrf_field() }}
                                <div class="form-group has-feedback has-feedback-left">
                                    <input name="sms_code" type="number" class="form-control" placeholder="Confirm code">
                                ...
                                <a  class="help-block text-danger" style="color:black" href="{{ url('showcode/'.$u_id) }}">Send confirmation code again!</a>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block">Confirm <i class="icon-circle-right2 position-right"></i></button>
                                </div>
                            </form>
                            <form action="/">
                                <div class="form-group">
                    ...
                    @elseif(isset($contact_system_administrator) &&  $contact_system_administrator == 1)
                        <center>
                            <img src="{{ asset('/') }}landing/img/wrong.png"></img>
                            <h1 style="color:red;">Please Contact System Administrator <br> {{ App\Settings::where('type','phone')->value('value') }} <br> {{ App\Settings::where('type','email')->value('value') }} </h1>
                        </center>
                    @elseif(isset($send_code) &&  $send_code == 1)

                        <form class="signupForm" method="POST" action="{{ url('send_code') }}" >
                            {{ csrf_field() }}
...
<!-- select select -->
                            ...
                            <div class="form-group has-feedback has-feedback-left">
                                <input name="phone_code" type="number" class="form-control" placeholder="Your mobile number">
                                <input name="user_id" type="hidden" value="{{ $u_id }}">
                                <div class="form-control-feedback">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">Send <i class="icon-circle-right2 position-right"></i></button>
                            </div>
                        </form>
                        <form action="/">
                            <div class="form-group">
                    ...
                    @elseif(isset($forget) &&  $forget == 1)
                        <form class="signupForm" method="POST" action="{{ url('forget_password') }}" >
                            {{ csrf_field() }}
                    ...
                    @elseif(isset($reset) &&  $reset == 1 && isset($token))
                        <form class="signupForm"method="POST" action="{{ url('reset') }}" >
                            {{ csrf_field() }}
                    ...
                    @elseif(isset($mailsend) &&  $mailsend == 0)
                        <center>
                            <img src="{{ asset('/') }}landing/img/wrong.png"></img>
                            <h1 style="color:red;">Error in your email address </h1>
                    ...
                    @elseif(isset($mailsend) &&  $mailsend == 1)
                        <center>
                            <img src="{{ asset('/') }}landing/img/true.png"></img>
                            <h1 style="color:green;">Plases check your email then click on reset button to change your passwords.</h1>
                            <form class="signupForm" action="/">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block"> Login <i class="icon-circle-right2 position-right"></i></button>
                                </div>
                    ...
                    @else
                        <div class="panel-body">
                            <!-- end check -->
                            @if(!isset($user_exist) and !isset($phone_error))
                                <div class="tabbable">
                                    <ul class="nav nav-tabs nav-tabs-bottom bottom-divided nav-justified nav-tabs-icon">
                                        <!-- if PMS on and Branch premium login state off we will remove premium login -->
                                        @if(!isset($pmsPremiumLoginDisabled))
                                            @if(App\Settings::where('type', 'disableLogin')->value('state')!=1)
                                            <li  @if( !Session::has('Accountkit') and !isset($social_mobile_exist)  and !isset($mobile_exist) and App\Settings::where('type', 'signupDefault')->value('state')!=1 ) class="active" @endif><a href="#tab1" data-toggle="tab"><i class="icon-menu7"></i> @if($pmsIntegrationState == "1" ) {{App\Settings::where('type', 'pms_premium_portal_label')->value('value')}} @else Sign in  @endif </a></li>
                                            @endif
                                        @endif

                                        <!-- if PMS on and Branch Complementary login state off we will remove Complementary login -->
                                        @if(!isset($pmsComplementaryLoginDisabled))
                                        <li  @if( (Session::has('Accountkit')) or (isset($social_mobile_exist) && $social_mobile_exist == 1) or (isset($mobile_exist) &&  $mobile_exist == 1) or (App\Settings::where('type', 'signupDefault')->value('state')==1) )  class="active" @endif><a href="#tab2" data-toggle="tab"> @if($pmsIntegrationState == 1) <i class="icon-connection"></i> {{App\Settings::where('type', 'pms_complementary_portal_label')->value('value')}}  @else <i class="icon-connection"></i> Wi-Fi @endif </a></li>
                                        @endif
                                    ...
                                    <div class="tab-content">
                                            ...
                                            @if(!isset($pmsPremiumLoginDisabled))
                                                ...
                                                @if(App\Settings::where('type', 'disableLogin')->value('state')!=1)
                                                    <div @if( (Session::has('Accountkit')) or (isset($social_mobile_exist) && $social_mobile_exist == 1) or (isset($mobile_exist) &&  $mobile_exist == 1) or (App\Settings::where('type', 'signupDefault')->value('state')==1) ) class="tab-pane" @else  class="tab-pane active" @endif id="tab1">
                                                        ...
                                                        <form class="signupForm" method="POST" action="{{ url('userlogin') }}">
                                                            {{ csrf_field() }}
                                                            <br>
                                                            @if(isset($errorMessage))<center><span style="color:red;" class="help-block text-danger"><i class="icon-cancel-circle2 position-left"></i>  {{ $errorMessage }} </span> </center>@endif

                                                            <div class="form-group has-feedback has-feedback-left">
                                                                <input name="username" value="{{Request::old('username')}}" class="form-control" style="" @if(App\Settings::where('type', 'getUserName')->value('state') !=1 and $pmsIntegrationState != 1) type="text" placeholder="Username" @elseif($pmsIntegrationState == "1" ) type="text" placeholder="{{App\Settings::where('type', 'pms_login_username_portal_label')->value('value')}}"  @else placeholder="Mobile number" type="number" @endif>
                                                                <div class="form-control-feedback">
                                                                    <i class="icon-user text-muted"></i>
                                                                </div>
                                                            ...
                                                            @if(App\Settings::where('type', 'getPassword')->value('state')==1)
                                                                <div class="form-group has-feedback has-feedback-left">
                                                                    <input name="password" value="{{Request::old('password')}}" type="password" class="form-control" @if($pmsIntegrationState == "1" ) placeholder="{{App\Settings::where('type', 'pms_login_password_portal_label')->value('value')}}"  placeholder="{{App\Settings::where('type', 'pms_login_password_portal_label')->value('value')}}" @else placeholder="Password"  @endif>
                                                                    <div class="form-control-feedback">
                                                            ...
                                                            @if(App\Settings::where('type', 'pms_integration')->value('state')==1 && App\Settings::where('type', 'pms_save_mobile_from_login_page')->value('state')==1)
                                                                ...
                                                                <select class="select-fixed-single" data-width="100%" required name="countryCodeForPms" id="country">
                                                                <?php $systemCountry=App\Settings::where('type', 'country')->value('value'); ?>
                                                                    ...
                                                                    <option @if($systemCountry=="EGYPT" or $systemCountry=="Egypt") selected @endif value="+2">Egypt +2</option>
                                                                    <option @if($systemCountry=="Palestine") selected @endif value="972"> Palestine +972 </option>
                                                                ...
                                                                <div class="form-group has-feedback has-feedback-left">
                                                                    <input name="MobileNumberForPms" type="text" class="form-control" placeholder="Mobile Number">
                                                                    <div class="form-control-feedback">
                                                                        <i class="icon-mobile text-muted"></i>
                                                                    </div>
                                                                    <!--<span class="help-block text-danger"><i class="icon-cancel-circle2 position-left"></i> </span>-->
                                                            ...
                                                            @if(App\Settings::where('type', 'pms_integration')->value('state')==1 && App\Settings::where('type', 'pms_save_email_from_login_page')->value('state')==1)
                                                                ...
                                                                <div class="form-group has-feedback has-feedback-left">
                                                                    <input name="emailForPms" type="email" class="form-control" placeholder="Email" >
                                                                    <div class="form-control-feedback">
                                                            ...
                                                            <div class="form-group">
                                                                <button id="login" type="submit" name="submit" class="btn btn-primary btn-block">Sign in <i class="icon-circle-right2 position-right"></i></button>
                                                            </div>
                                        ...
                                        @else
                                            ...
                                            <!--<center><a href="{{url('account')}}" class="login btn btn-primary btn-block">Profile <i class="icon-circle-right2 position-right"></i></a> </center>-->
                                        @endif
                            ...
                            @endif
                                        ...
                                        @if(!isset($pmsComplementaryLoginDisabled))
                                            ...
                                            <div @if( (Session::has('Accountkit')) or (isset($social_mobile_exist) && $social_mobile_exist == 1) or (isset($mobile_exist) &&  $mobile_exist == 1) or (App\Settings::where('type', 'signupDefault')->value('state')==1) or (App\Settings::where('type', 'disableLogin')->value('state')==1) ) class="tab-pane active" @else class="tab-pane" @endif id="tab2">
                                                ...
                                                @if( App\Settings::where('type', 'Accountkitappid')->value('state') == 1 && !Session::has('Accountkit') && !Session::has('AccountkitFullMobile') && ( !isset($_GET['status']) and !isset($_GET['code']) or isset($_GET['status']) and $_GET['status']!="PARTIALLY_AUTHENTICATED" ) )

                                                    @if(isset($mobile_exist) && $mobile_exist == 1)
                                                        <br><center><span style="color:red;"><i class="icon-cancel-circle2 position-left"></i> Hmmm, Mobile already exist</span></center>
                                                    @endif
                                                    <br>
                                                    <form class="signupForm" action="https://www.accountkit.com/v1.0/basic/dialog/sms_login/" method="get" id="form">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <?php $systemCountry=App\Settings::where('type', 'country')->value('value'); ?>
                                                                    ...
                                                                    <option @if($systemCountry=="Lebanon") selected @endif value="+961">Lebanon +961</option>
                                                                    <option @if($systemCountry=="Jordan") selected @endif value="+962">Jordan +962</option>
                                                                    <option @if($systemCountry=="EGYPT" or $systemCountry=="Egypt") selected @endif value="+20">Egypt +2</option>
                                                                    <option @if($systemCountry=="Palestine") selected @endif value="972"> Palestine +972 </option>
                                                                    <option @if($systemCountry=="Gambia") selected @endif value="+220">Gambia +220</option>
                                                                    <option value="39">Italy +39 </option>
                                                                    <option value="7">Russia +7 </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback has-feedback-left">
                                                                <input type="number" class="form-control" name="phone_number" placeholder="Mobile number" id="phone">
                                                                <div class="form-control-feedback">
                                                                    <i class="icon-mobile text-muted"></i>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <button type="submit" class="btn btn-danger btn-rounded btn-block">Next <i class="icon-circle-right2 position-right"></i></button>
                                                    </form>
                                                        
                                                    <!-- <button type="submit" class="btn btn-primary btn-block" onclick="smsLogin()" id="accountkit_signup">Sign up <i class="icon-circle-right2 position-right"></i></button> -->
                                                @else
                                                <!-- Normal signup without accountkit or any integration-->
                                                <?php 
                                                        ...
                                                        //     }
                                                        // }
                                                    // if(Session::has('AccountkitFullMobile')){                                                    
                                                    //     //print_r(Session::has('AccountkitFullMobile'));
                                                    // }
                                                ?>
                                                <form method="POST" action="{{ url('signup') }}" class="signup signupForm" id="signupFormToViewOrHidden">
                                                    {{ csrf_field() }}
                                                    @if(App\Settings::where('type', 'Accountkitappid')->value('state') == 1)
                                                        ...
                                                        <br>
                                                            @if(isset($errorMessage))
                                                                <center><span style="color:red;" class="help-block text-danger"><i class="icon-cancel-circle2 position-left"></i>  {{ $errorMessage }} </span> </center>
                                                            @else
                                                                <center><h2 style='color: green;'><i class="icon-checkmark4"></i> Your Mobile has been confirmed,</h2><h4>Please enter this informations to complete registration. </h4></center>	
                                                            @endif
                                                    @else
                                                        @if(isset($errorMessage))
                                                            <center><span style="color:red;" class="help-block text-danger"><i class="icon-cancel-circle2 position-left"></i>  {{ $errorMessage }} </span> </center>
                                                    ...
                                                    @if(App\Settings::where('type', 'getNetwork')->value('state')==1)
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control select-fixed-single" name="network">
                                                    ...
                                                    @if(App\Settings::where('type', 'getGender')->value('state')==1)
                                                        <div class="form-group has-feedback has-feedback-left">
                                                            Title: <i class="icon-man"><input name="gender" id="reg-gender" required="required" value="1" type="radio" > Mr.</i>  &nbsp&nbsp
                                                            <i class="icon-woman"><input name="gender" value="0" id="reg-gender" type="radio" > Ms.</i><br> 
                                                        </div>
                                                    @endif

                                                    @if(App\Settings::where('type', 'getName')->value('state')==1)
                                                        <div class="form-group has-feedback has-feedback-left">
                                                            <input name="name" id="reg-name" type="text" class="form-control" placeholder="Full Name" required="required" aria-required="true">
                                                            <div class="form-control-feedback">
                                                    ...
                                                    @if(App\Settings::where('type', 'getMobileInSignupTab')->value('state') != 0)	
                                                        <div class="input-group">
                                                            <div class="input-group-addon">
                                                                <i class="icon-earth"></i>
                                                            </div>

                                                            <select class="form-control select-fixed-single" name="countrycode" id="countrycode">
                                                            <?php $systemCountry=App\Settings::where('type', 'country')->value('value'); ?>
                                                            <option value="39">Italy +39 </option>
                                                            <option value="7">Russia +7 </option>
                                                            <option value="49">Germany +49</option>
                                                            ...
                                                            <option @if($systemCountry=="Saudi Arabia") selected @endif value="966">Saudi Arabia +966
                                                                ...
                                                                <option @if($systemCountry=="EGYPT" or $systemCountry=="Egypt") selected @endif value="2">Egypt +2
                                                                </option>
                                                                <option @if($systemCountry=="Palestine") selected @endif value="972">Palestine +972
                                                                </option>
                                                    ...
                                                    <div class="form-group has-feedback has-feedback-left">
                                                        ...
                                                        @if(App\Settings::where('type', 'getMobileInSignupTab')->value('state') != 0)
                                                            <input name="phone" type="number" class="form-control" placeholder="Mobile number" required="required" aria-required="true" maxlength="11" onkeypress="return isNumber(event)" id="phone">
                                                            <div class="form-control-feedback">
                                                                <i class="icon-mobile text-muted"></i>
                                                            </div>
                                                        ...
                                                        @if(App\Settings::where('type', 'getCardSerialInSignupTab')->value('state') ==1)
                                                            <div class="form-group has-feedback has-feedback-left">
                                                            <input name="cardSerial" minlength="8" maxlength="8" id="cardSerial" type="text" class="form-control" placeholder="Card Number" required="required">
                                                            <span class="help-block">You can buy a premium card from reception, then enter the card number here.</span>
                                                            <input type="hidden" id="phonevalid" value="0">
                                                            <div class="form-control-feedback">
                                                        ...
                                                        @if(App\Settings::where('type', 'getUserName')->value('state') !=1)
                                                            <div class="form-group has-feedback has-feedback-left">
                                                                <input name="username" type="text" class="form-control" placeholder="Username" style="" required="required" aria-required="true" id="username">
                                                                <div class="form-control-feedback">
                                                                    <i class="icon-user text-muted"></i>
                                                                </div>
                                                        ...
                                                        @if(App\Settings::where('type', 'getPassword')->value('state')==1 and $pmsIntegrationState != "1")
                                                            <div class="form-group has-feedback has-feedback-left">
                                                                <input name="password" type="password" class="form-control" placeholder="Password" required="required" aria-required="true">
                                                                <div class="form-control-feedback">
                                                        ...
                                                        @if(App\Settings::where('type', 'getEmail')->value('state')==1)
                                                            <div class="form-group has-feedback has-feedback-left">
                                                                <input name="email" type="email" class="form-control" placeholder="Email" required="required" aria-required="true" id="email">
                                                                <div class="form-control-feedback">
                                                                    <i class="icon-mention text-muted"></i>
                                                                </div>
                                                        ...
                                                        @if(App\Network::value('r_type') == "2")
                                                            @if(App\Settings::where('type', 'Accountkitappid')->value('state') != 1)
                                                                <!-- <center><span style="color:black;" align="center"> You will receive verification code </span></center> -->
                                                            @endif
                                                        @endif

                                                        @if(isset($phone_error) &&  $phone_error == 1)
                                                            <center><span style="color:red;"><i class="icon-cancel-circle2 position-left"></i> Please check your mobile number</span></center>
                                                        @endif

                                                        @if(isset($user_exist) &&  $user_exist == 1)
                                                            <center><span style="color:red;"><i class="icon-cancel-circle2 position-left"></i> Hmmm, Username already exist</span></center>
                                                        @endif
                                                        
                                                        @if(isset($mobile_exist) &&  $mobile_exist == 1)
                                                            <center><span style="color:red;"><i class="icon-cancel-circle2 position-left"></i> Hmmm, Mobile already exist</span></center>
                                                        @endif
                                                        
                                                        @if(isset($email_exist) &&  $email_exist == 1)
                                                            <center><span style="color:red;"><i class="icon-cancel-circle2 position-left"></i> Hmmm, Email already exist</span></center>
                                                        @endif
                                                    </div>
                                                    <!--<div class="form-group">
                                                        <div class="checkbox">
                                                    ...
                                                    @if( App\Settings::where('type', 'firebaseAuthentication')->value('state') != 1 )
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-primary btn-rounded btn-block" id="signup">Register <i class="icon-circle-right2 position-right"></i></button>
                                                        </div>
                                                    @endif
                                                </form>
                                                    @if( App\Settings::where('type', 'firebaseAuthentication')->value('state') == 1 )
                                                        ...
                                                        <div class="form-group">
                                                            <button disabled class="btn btn-primary btn-rounded btn-block" id="sign-in-button">Next <i class="icon-circle-right2 position-right"></i></button>
                                                        </div>
                                                        ...
                                                        <form id="verification-code-form" action="#">
                                                            <center>
                                                            <img src="{{ asset('/') }}landing/img/true.png"></img>
                                                            <h4 style="color:green;">Please check your mobile to get SMS or WhatsApp verification code</h4>
                                                            </center>

                                                            {{ csrf_field() }}
                                                            <div class="form-group has-feedback has-feedback-left">
                                                                <input name="sms_code" type="number" class="form-control" id="verification-code" placeholder="Confirm code">
                                                            </div>
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-primary btn-block" id="verify-code-button">Confirm </button>
                                                            </div>
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-block" id="cancel-verify-code-button"> Cancel...! </button>
                                                            </div>
                                                            <div class="form-group">
                                                                <button class="btn btn-block" id="sign-out-button">Sign-out</button>
                                                            </div>
                                                        </form>
                                                        <!-- ----------------------------------->
                                                        <!-- <input name="response" type="text" id="response"> -->
