...
<body class="login-container fr3on">
            ...
            <div class="content">
                ...
                <div class="footer text-muted text-center panel panel-body" style=" background-color: rgba(51, 51, 51, 0.8);  border: 0px solid transparent;">
                                        ...
                                        <div class="row">
                                            <form action="{{ url('get_offer') }}" method="post" id="get-offer">
                                                ...
                                                @if($campaign->offer_sendsms == 1)
                                                    <div class="row">
                                                        <h6 class="text-semibold">Enter your mobile number to recive your offer code by SMS</h6>
                                                ...
                                                @if($campaign->offer_sendmail == 1)
                                                    <center><h6 class="text-semibold">Enter your email to recive your offer code</h6>
                                                    </center>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-success" onclick="document.forms['get-offer'].submit(); return false;">Confirm</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    @elseif($campaign->type == "video") <!-- Connect and visit -->
                            <div class="text-center">
                                <!--<div class="icon-object border-slate-300 text-slate-300"><i class="icon-quill4"></i></div>-->
                                <h2 style="color: #fff;">{{ $campaign->description }}</h2>
                            </div>
                            <center>

                                <div style="z-index: 1000; width: 100%; height: 100%">
                                    <iframe frameborder="0" height="100%" width="100%" src="https://www.youtube.com/embed/{{$campaign->video_url}}?autoplay=1&controls=0&showinfo=0&autohide=1&loop=10">
