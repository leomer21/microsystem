...
<head>
    ...
    <title>{{ $campaigns->offer_title }} &nbsp</title> 

    <!-- For facebook and twitter social share  -->
    <meta property="og:type" content="website" />
    <meta property="og:title" content="{{ $campaigns->offer_title }}" />
    <meta property="og:description" content="{{ $campaigns->offer_desc }}" />
    <meta property="og:site_name" content="{{ $campaigns->offer_title }}" />
    <?php $pic = App\Media::where('type', 'campaigns')->where('campaign_id', $campaigns->id)->take(1)->get(); ?>
    @if(isset($pic) && count($pic) == 1)
        @foreach($pic as $campaignImage)
            <meta property="og:image" content="{{ asset('') }}upload/campaigns/{{ $campaignImage->file }}" />
            <meta name="twitter:image" content="{{ asset('') }}upload/campaigns/{{ $campaignImage->file }}" />
        @endforeach
    @endif
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="{{ $campaigns->offer_title }}" />
    <!-- For facebook and twitter social share  -->
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <!-- Registration form -->
                <form action="{{ url('signupoffer') }}" method="post" id="signupoffer">
                    {{ csrf_field() }}
                    <div class="row">
                            ...
                            <div class="panel registration-form panel-transparent">
                                <div class="panel-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="submit"
                                                class="btn bg-teal-400 btn-labeled btn-labeled-right ml-10" onclick="loadingIcon();" id="loadingButton"><b><i
                                                        class="icon-gift"></i></b> Get my offer code NOW !
                                        </button>
                                        <script>
