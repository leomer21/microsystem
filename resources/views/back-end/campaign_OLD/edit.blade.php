                                       ...
                                       <?php if($campaign_type == "survey"): ?>
                                           ...
                                           <?php foreach($campaigns_survey as $value): ?>
                                            {
                                                ...
                                                data: [
                                                    <?php if($campaigns->survey_type == "rating"): ?>
                                                        <?php 
                                                        ...
                                                        foreach($allDayData as $record){
                                                            $finalValue[$record->day] = count($record->operation == "campaigns_survey_rating");
                                                        }
                                                            for($i=1;$i<=31;$i++)
                                                            {
                                                                echo "'";
                                                    ...
                                                    <?php if($campaigns->survey_type == "poll"): ?>
                                                        <?php 
                                                        foreach ($campaigns_survey as $key => $value) {
                                                            ...
                                                            foreach($allDayData as $record){
                                                                ...
                                                                $finalValue[$record->day] = count($record->survey_id == "campaigns_survey_poll");
                                                            }
                                                                for($i=1;$i<=31;$i++)
                                                                {
                                                                    echo "'";
                                        ...
                                        series: [
                                            ...
                                            },
                                            {
                                                ...
                                                type: 'bar',
                                                data: [
                                                    <?php foreach($reachData as $record){
