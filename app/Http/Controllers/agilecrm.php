...
define("AGILE_DOMAIN", App\Settings::where('type', 'agile_domain_name')->value('value'));  # Example : define("domain","jim");
define("AGILE_USER_EMAIL", App\Settings::where('type', 'agile_admin_email')->value('value'));
define("AGILE_REST_API_KEY", App\Settings::where('type', 'agile_rest_api')->value('value'));
